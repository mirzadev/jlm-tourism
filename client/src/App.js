          ...
          <StoreProvider>
            ...
            <footer className='row center mt-3' id="footer-items">
              <div className="hotels-cars">
                ...
                <a className="weather-condition" href="https://www.accuweather.com/en/us/hollywood/33020/weather-forecast/332286" target="_blank"> <img src="/images/weather-icon.png" role="img" aria-label="Weather icon" class="icon" style={{ width: 40, height: 40 }} />Local Weather</a>
